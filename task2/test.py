...
def main():
    ...
    parser.add_argument('--scoring', default='macro', help='Evaluation Measure.')
    parser.add_argument('--minibatch_size', type=int, default=256, help='Mini-batch Size.')
    parser.add_argument('--name_count', default='cnn_1', help='count which run')
    ...
    # Evaluate
    prf1 = None
    filename = '/home/sehan2/Amia/task2/nn_model/probas_full1/'+str(args.name_count)+'.npy'
    ...
    if args.scoring == 'binary':
        ...
        f1 = f1_score(Y.argmax(axis=1), all_preds, average='macro', labels=[0,1])
